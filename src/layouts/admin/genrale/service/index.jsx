...
<div className="p-2 text-3xl font-bold">Services</div>
    ...
    <div className="min-w-full inline-block align-middle">
      <div className="relative  text-gray-500 focus-within:text-gray-900 mb-4">
        ...
        <Link to={'/admin/service/add'} >
          ...
          <button className="bg-[#1FAE72] px-4 py-2 text-white rounded-xl">
Add
  </button>
   </Link>
  </div>
            ...
            <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
              ...
              <td className=" p-5 ">
                <div className="flex items-center gap-1">
                  ...
                  </button><Link to={'/admin/service/1'}>

<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#1FAE72" className="size-6">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                      ...
                      <Link to={'/admin/service/2/dd/edit'} >
