...
export default function ServicesDetails(){
    return(
        ...
        <button
  type="button"
  class="bg-white text-center w-40 rounded-2xl h-14 relative font-sans text-black text-xxl font-semibold group"
>
  <div
    class="bg-[#1FAE72] rounded-xl h-10 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[184px] z-10 duration-500"
  >
    <svg
      width="25px"
      height="25px"
...
<div className="p-2 text-3xl font-bold">Hairs</div>
...
<Link to={'/admin/service/1/add'}>
          <button className="bg-[#1FAE72] px-4 py-2 font-bold text-white rounded-xl">
Add
  </button>
</Link>
      ...
      <table className=" bg-white rounded-xl min-w-full rounded-xl">
          <thead>
          ...
          <tbody className="divide-y divide-gray-300 ">
            ...
            <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
              ...
              <td className=" p-5 ">
                  ...
                  <Link to={'/admin/service/details/2/dd/edit'} >
               
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#1FAE72" className="size-6">
