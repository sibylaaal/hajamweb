...
export default function ServicesDetailsadd() {
          ...
          <div className="min-w-full inline-block align-middle">
            ...
            <div className="flex justify-end mt-5">
              <button
                ...
                className="px-5 tracking-wide font-semibold bg-[#1FAE72] text-white py-2 rounded-lg hover:bg-green-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
              >
